    ...
    <section className="bg-gray-50 py-28">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-start">
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight mb-6">
            Trusted Electrical Solutions <br /> For Industrial Excellence
          </h2>

          <p className="text-gray-500 max-w-xl mb-10 leading-relaxed">
            Rihan Power Enterprises is an ISO 9001:2015 certified electrical
            engineering company specializing in design, manufacturing,
            installation and commissioning of electrical control panels
            and power distribution systems for industrial and commercial
            projects. We focus on quality, safety and long-term reliability.
          </p>
          ...
          <div className="space-y-8">
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Panels are manufactured as per ISO 9001:2015 standards ensuring
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  From system design and panel fabrication to site installation
                  and commissioning, we handle the entire project lifecycle.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Extensive experience in LT, MCC, PCC, PLC automation,
                  APFC panels and power distribution systems.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white shadow-xl rounded-xl p-12">
          ...
          <h3 className="text-3xl font-bold text-gray-900 mb-8">
            Get In Touch For Your <br /> Electrical Project Requirement
          </h3>
