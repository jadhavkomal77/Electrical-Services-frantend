...
//           {/* EXPERIENCE BADGE (SUBTLE & PROFESSIONAL) */}
//           <div className="absolute bottom-5 left-5 bg-white/90 backdrop-blur border border-gray-200 px-5 py-3 rounded-lg shadow-md animate-scale-in">
//             <h3 className="text-2xl font-bold text-gray-900 leading-none">
//               {about.experience}+
//             </h3>
//             <p className="text-[11px] text-gray-500 mt-1 tracking-wide uppercase">
//               Years Experience
//             </p>
//           </div>
//         </div>
...
//           <h2 className="text-[36px] md:text-[42px] font-bold text-gray-900 leading-tight mb-4">
//             {about.title}
//           </h2>
...
//           <button className="bg-red-500 text-white px-8 py-3 rounded-md font-semibold hover:bg-red-600 transition">
//             Discover More
//           </button>
//         </div>
